  ...
  <div class="shop">
    <div class="head">
      <div class="info">
        ...
        <div class="my">
          <el-button style="width: 250px;background: white;color: black"
                     size="medium"
                     type="primary"
                     @click="toMyHome">
            进入我的主页
    ...
    <div class="shop">
      <div v-for="(item,index) in vegetables"
           :key="index"
           class="item">
    ...
    <div v-for="(ball, index) in balls"
      ...
      <transition @before-enter="beforeDrop"
        ...
        <div class="ball"
             v-show="ball.show">
          <div class="inner inner-hook"><img :src="ball.url"
                 alt=""
                 class=""></div>
        </div>
      </transition>
    ...
    <shopping id="shopping"
              ref="shopping"
              @onClick="clickShop"></shopping>
    <el-dialog class="dialog"
               title="我的购物车"
               :visible.sync="outDialogShopCart"
               width="40%">
      <el-dialog width="30%"
                 title="提示"
        ...
        <el-table-column property="num"
          ...
          <template slot-scope="select">
            <div class="select-container">
              <div class="but cut"
                   @click.stop="cutNum(select.$index)">-</div>
              <span>{{select.row.num}}</span>
              <div class="but add"
                   @click.stop="addNum(select.row)">+</div>
            </div>
          </template>
        </el-table-column>
...
export default {
  data () {
    return {
      ...
      vegetables: [
        {
          image: 'https://img2.baidu.com/it/u=2543701919,1997443201&fm=26&fmt=auto&gp=0.jpg',
          name: '证书1',
          stock: 10,
          price: 5
        }
  ...
  created () {
    ...
    this.fruit = [
      {
        image: 'https://img0.baidu.com/it/u=3585932291,2434523756&fm=224&fmt=auto&gp=0.jpg',
        name: '徽章 1',
        stock: 10,
        price: 5
      },
